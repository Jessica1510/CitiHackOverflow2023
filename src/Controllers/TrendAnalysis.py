...
def forecast():
    ...
    fig.write_image("src/imgs/forecast-graph.svg")
    # Read the SVG content and encode it
    with open("src/imgs/forecast-graph.svg", "rb") as svg_file:
...
def loadData(Company):
    try:
        ...
        encoded_svg = forecast()
        return encoded_svg, json_formatted
